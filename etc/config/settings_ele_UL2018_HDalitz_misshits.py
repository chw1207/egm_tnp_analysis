...
baseOutDir = 'results/UL2018/tnpEleID_misshits/'
...
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/data4/chenghan/tnpTuples/UL2018/PU_Trees/DY_madgraph_ele.pu.puTree.root')
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('/data4/chenghan/tnpTuples/UL2018/PU_Trees/DY_amcatnloext_ele.pu.puTree.root')
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/data4/chenghan/tnpTuples/UL2018/PU_Trees/DY_madgraph_ele.pu.puTree.root')
