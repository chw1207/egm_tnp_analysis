...
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_weight(weightName)
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_weight(weightName)
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/data4/chenghan/tnpTuples-unseedDiPhoHLT/UL2017_PU_Trees/DY_madgraph_ele.pu.puTree.root')
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('/data4/chenghan/tnpTuples-unseedDiPhoHLT/UL2017_PU_Trees/DY_amcatnloext_ele.pu.puTree.root')
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/data4/chenghan/tnpTuples-unseedDiPhoHLT/UL2017_PU_Trees/DY_madgraph_ele.pu.puTree.root')
