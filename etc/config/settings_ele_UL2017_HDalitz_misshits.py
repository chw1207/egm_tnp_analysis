...
baseOutDir = 'results/UL2017/tnpEleID_misshits/'
...
if not samplesDef['mcNom' ] is None: samplesDef['mcNom' ].set_puTree('/data4/chenghan/tnpTuples/UL2017/PU_miniAOD/DY_madgraph_ele.pu.puTree.root')
if not samplesDef['mcAlt' ] is None: samplesDef['mcAlt' ].set_puTree('/data4/chenghan/tnpTuples/UL2017/PU_miniAOD/DY_amcatnloext_ele.pu.puTree.root')
if not samplesDef['tagSel'] is None: samplesDef['tagSel'].set_puTree('/data4/chenghan/tnpTuples/UL2017/PU_miniAOD/DY_madgraph_ele.pu.puTree.root')
...
#   { 'var' : 'el_pt' , 'type': 'float', 'bins': [10,20,35,50,100,500] },
   { 'var' : 'el_pt' , 'type': 'float', 'bins': [25, 30, 40, 60, 150, 500] },
...
#############################################################
### cut
cutBase   = 'tag_Ele_pt > 35 && abs(tag_sc_eta) < 2.17 && el_q*tag_Ele_q < 0 && el_pt > 25 && abs(el_sc_eta) < 2.5'
