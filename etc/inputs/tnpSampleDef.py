...
# copy from
# '/eos/cms/store/group/phys_egamma/tnpTuples/tomc/2020-05-20/UL2017/merged/'
# '/eos/cms/store/group/phys_egamma/tnpTuples/tomc/2020-05-20/UL2018/merged/'
eosUL2017 = '/data4/chenghan/tnpTuples/UL2017/'
eosUL2018 = '/data4/chenghan/tnpTuples/UL2018/'

# copy from
# '/eos/cms/store/group/phys_egamma/tnpTuples/rasharma/2021-02-10/UL2016preVFP/merged/'
# '/eos/cms/store/group/phys_egamma/tnpTuples/rasharma/2021-02-10/UL2016postVFP/merged/'
eosUL2016pre = '/data4/chenghan/tnpTuples/UL2016preVFP/'
eosUL2016post = '/data4/chenghan/tnpTuples/UL2016postVFP/'
...
UL2016_preVFP = {
    ...
    # 'data_Run2016B_ver2' : tnpSample('data_Run2016B_ver2' , eosUL2016pre + 'UL2016_SingleEle_Run2016B_ver2.root' , lumi = 5.879330594),
